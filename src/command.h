...
#define N_CMD 10  /*!< Total number of CommandCode in the enum */
...
typedef enum { NO_CMD = -1, UNKNOWN, EXIT, SOUTH, NORTH, EAST, WEST, TAKE, DROP, CHAT} CommandCode; /* All values that a command can take */
