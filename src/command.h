...
#define N_CMD 19  /*!< Total number of CommandCode in the enum */
...
typedef enum { NO_CMD = -1, UNKNOWN, EXIT, SOUTH, NORTH, EAST, WEST, TAKE, DROP, CHAT, ATTACK, RUN_AWAY, SWITCH, ABILITY, OBJECT_USE, HELP, MOVE, SEARCH, INSPECT} CommandCode; /* All values that a command can take */
