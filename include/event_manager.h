...
#define N_EVENTS 16 /*!< Number of events implemented*/
...
END_ON_KILL_ENEMY, DEATH_DIALOGUE, DIALOGUE_IN_SPACE, DIALOGUE_COMPLETE, UNLOCK_ON_KILL, SPACE_END}EventType;
